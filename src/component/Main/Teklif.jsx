                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
                    <div className="relative overflow-hidden rounded-3xl shadow-2xl bg-white">
                        ...
                        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-5 overflow-hidden">
                                ...
                                <div className="h-full">
                                    <div className="relative h-full">
                                        ...
                                        <div className="absolute inset-0 flex flex-col justify-between p-8 md:p-12">
                                            <div>
                                                <h1 className="font-manrope text-white text-3xl md:text-5xl font-bold leading-tight">
                                                    Təkliflərinizi <br/>
                                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-200 to-purple-200">
                                                        Bizimlə Paylaşın
                                                    </span>
                                                </h1>
                                                <p className="text-white text-lg mt-6 max-w-md opacity-90">
                                                    Fikirlərinizi və təkliflərinizi bizə göndərin, ən qısa zamanda sizinlə əlaqə saxlayacağıq.
                                                </p>
                                            </div>
                            ...
                            <div className="lg:col-span-3 p-8 md:p-16 relative z-10">
                                <div className="max-w-lg mx-auto">
                                    ...
                                    <p className="text-gray-600 mb-10 text-lg">
                                        Formu doldurun və bizim komanda üzvlərimizdən biri tezliklə sizinlə əlaqə saxlayacaq.
                                    </p>
                                    ...
                                    <div className="mt-8 text-center">
                                        <p className="text-gray-500 text-sm">
                                            Bütün məlumatlarınız təhlükəsiz şəkildə saxlanılır və heç bir üçüncü tərəflə paylaşılmır.
                                        </p>
                                    </div>
                                </div>
                            </div>
