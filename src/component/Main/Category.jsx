...
function Category() {
  ...
  `}
  style={{
    scrollbarWidth: 'none', // Firefox üçün scrollbar gizlətmə
    WebkitOverflowScrolling: 'touch', // daha səlis sürüşdürmə üçün
  }}
>
  {category.slice(0, 4).map((item, i) => {
    ...
    return (
      <Link
        ...
        className="group snap-start flex-shrink-0 w-[85%] sm:w-[48%] md:w-auto"
      >
